...
function KhaiBaoKetQuaXetNghiem() {
...

        {
            ...
            render: (record) => (
                <div className="d-flex justify-content-center">
                    ...
                    >
                        <Button
                            className="bg-light xn-danhmuc-icon-modify"
                            onClick={() => {
                ...
                <div className="text-muted">
                    <div className="d-flex justify-content-between align-items-center mt-2 mx-2">
                        <div className="d-flex align-items-center ">
                            <div className="xn-danhmuc-title mx-2"><FontAwesomeIcon icon={faBars} /> Khai báo tên kết qủa xét nghiệm</div>
                        </div>
...
export default KhaiBaoKetQuaXetNghiem;
