...
function Khaibaouser() {
    ...
    const column = [
        ...
        },
        {
            ...
            fixed: "right",
            render: (record) => (
                <div style={{ width: "80px", display: 'flex', justifyContent: 'center' }} className="d-flex justify-content-center">
                    <Dropdown
                        menu={{
                            items,
    ...
    return (
        <>
            <Helmet>
                <title>Khai Báo Tài Khoản - EmedLink </title>
            </Helmet>
            <div className="vh-100">
                ...
                <CtKhaibaouser
                    ...
                    key="ctKhaibaouser"
                />
                <div className="mt-2 p-1 danhmuc">
                    <Table
