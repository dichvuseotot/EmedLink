...
function Sieuam() {
    ...
    return (
        <div className="indexSieuAm">
            <Helmet>
                <title>Siêu Âm - EmedLink </title>
            </Helmet>
            ...
            <div className="d-flex">
                <div
                    className={
                        click
                            ? "danhsach-left w-0 div-shadow"
                            : "danhsach-left w-25 div-shadow"
                    }
                >
                    <div
                        ...
                        <Form>
                            <div className="color-border m-1 pb-3 px-2">
                                <div>
                                    ...
                                    <div className="row row-height-1">
                                        <Form.Item
                                            label={
                                                <div className="form-input-label canlamsan-form-input-label">
                                                    CĐ sơ bộ
                                    ...
                                    <div className="row row-height-tex">
                                        <Form.Item
                                            label={
                                                <div className="form-input-label canlamsan-form-input-label">
                                                    DB Bệnh
