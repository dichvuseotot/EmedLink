                                    ...
                                    <div>
                                        ...
                                        <div className="row form-row">
                                            ...
                                            <Form.Item
                                                ...
                                                label={
                                                    <div className="tiepnhan-congkham-form-input-label gioitinh">
                                                        G.Tính
                                                    </div>
                                                }
                                            >
                            ...
                            <div className=" container m-0 p-0 tt-bhyt">
                                ...
                                <div className="row form-row row-fix">
                                    ...
                                    <Form.Item
                                        ...
                                        className="col-md-6 m-0"
                                    >
                                        <Input className="form-control date-tiepnhan-bh" type="date" />
                                    </Form.Item>
                                </div>
                                <div className="row form-row row-fix">
                                    <Form.Item
                        ...
                        <div className="row m-0 p-0">
                            <div className="col-md-7">
                                ...
                                <div className="row form-row">
                                    ...
                                    <Form.Item
                                        label={
                                            <div className="tiepnhan-congkham-form-input-label ksk">
                                                Khám sức khỏe
                                            </div>
                                        }
                                        className="col-md-3 m-0 mt-1"
