...
import "./capnhatphieunhapkho.scss";
...
function CapNhatPhieuNhapKho() {
    ...
    return (
        <div className="duyetphieudutru">
            <Helmet>
                <title>Cập Nhật Phiếu Nhập Kho - EmedLink </title>
            </Helmet>
            ...
            <div className="duyetphieulinh_tt">
                ...
                <div className="duyetphieulinh_right">
                    <div className="duyetphieulinh_title">Thông tin cập nhật phiếu nhập</div>
...
export default CapNhatPhieuNhapKho;
