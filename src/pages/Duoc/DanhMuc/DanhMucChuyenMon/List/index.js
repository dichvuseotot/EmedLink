...
function DanhMucChuyenMon() {
    ...
    return (
        <>
            <Helmet>
                <title>Danh Mục Chuyên Môn - EmedLink </title>
            </Helmet>
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                ...
                <div className="text-muted">
                    <div className="d-flex justify-content-between align-items-center mt-2 mx-2">
                        <div className="d-flex align-items-center ">
                            <div className="vienphi-danhmuc-title mx-2"><FontAwesomeIcon icon={faBars} /> Danh mục chuyên môn</div>
                        </div>
...
export default DanhMucChuyenMon;
