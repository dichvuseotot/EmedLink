...
import "./hoantranhacungcap.scss";
function PhieuHoanTraNhaCungCap() {
    ...
    return (
        <div className=" h-100">
            ...
            <div className="title-nhapkho">THÔNG TIN HOÀN TRẢ NHÀ CUNG CẤP</div>
            <div className="tt-hoantrakho">
...
export default PhieuHoanTraNhaCungCap;
