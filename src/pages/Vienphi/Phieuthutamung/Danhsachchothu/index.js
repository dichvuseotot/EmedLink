            ...
            <div className="d-flex">
                ...
                <div className={click ? "w-100" : "w-75"}>
                    ...
                    <div>
                        ...
                        <hr className="my-1" />
                        <div className="vienphi-border-tamung vp-phieuthutamung-bottom">
                            <Form>
                                <div className="row">
                                    <div className="w-15">
                                ...
                                <div className="chothu-tamung-bottom">
                                    <div className="row justify-content-center ">
                                        ...
                                        <div className="col-md-3 kb-checktoa p-0">
